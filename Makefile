...
# streamnative.io/pulsar-resources-operator-bundle:$VERSION and streamnative.io/pulsar-resources-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= streamnative.io/pulsar-resources-operator
...
license-eye: ## Download license-eye locally if necessary. https://github.com/apache/skywalking-eyes
	$(call go-get-tool,$(LICENSE_EYE),github.com/apache/skywalking-eyes/cmd/license-eye@main)
