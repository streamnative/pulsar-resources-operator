...
require (
	...
	github.com/jetstack/cert-manager v1.7.3 // indirect
	...
	github.com/streamnative/sn-operator/api v0.0.0-00010101000000-000000000000 // indirect
	github.com/streamnative/sn-operator/api/commons v0.0.0-00010101000000-000000000000 // indirect
	github.com/streamnative/sn-operator/pkg/commons v0.6.4 // indirect
...
replace (
	...
	github.com/streamnative/sn-operator/api => github.com/streamnative/sn-operator/api v0.9.0-rc.14
	github.com/streamnative/sn-operator/api/commons => github.com/streamnative/sn-operator/api/commons v0.9.0-rc.14
	github.com/streamnative/sn-operator/pkg/commons => github.com/streamnative/sn-operator/pkg/commons v0.9.0-rc.14
)

// kubernetes (apiserver, controller-runtime)
replace (
	github.com/google/cel-go => github.com/google/cel-go v0.17.7
	go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.5.10
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.10
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.10
...
replace github.com/streamnative/cloud-api-server => github.com/streamnative/cloud-api-server v1.33.1-0.20250227063727-b1c166fbb5f5
