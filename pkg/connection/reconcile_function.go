...
func (r *PulsarFunctionReconciler) ReconcileFunction(ctx context.Context, pulsarAdmin admin.PulsarAdmin,
	...
	if !instance.DeletionTimestamp.IsZero() {
		...
		if err := removeFinalizer(ctx, r.conn.client, instance, resourcev1alpha1.FinalizerName); err != nil {
	...
	if instance.Spec.LifecyclePolicy != resourcev1alpha1.KeepAfterDeletion {
		// TODO use otelcontroller until kube-instrumentation upgrade controller-runtime version to newer
		if err := ensureFinalizer(ctx, r.conn.client, instance, resourcev1alpha1.FinalizerName); err != nil {
