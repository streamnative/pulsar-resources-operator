...
import (
	...
	"github.com/streamnative/pulsar-resources-operator/pkg/streamnativecloud/client/clientset_generated/clientset/scheme"
	rest "k8s.io/client-go/rest"
)

type ComputeV1alpha1Interface interface {
	RESTClient() rest.Interface
	FlinkDeploymentsGetter
	WorkspacesGetter
}

// ComputeV1alpha1Client is used to interact with features provided by the compute.streamnative.io group.
type ComputeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ComputeV1alpha1Client) FlinkDeployments(namespace string) FlinkDeploymentInterface {
	return newFlinkDeployments(c, namespace)
}

func (c *ComputeV1alpha1Client) Workspaces(namespace string) WorkspaceInterface {
