...
func (in *RoleBindingSpec) DeepCopyInto(out *RoleBindingSpec) {
	*out = *in
	...
	if in.ConditionGroup != nil {
		in, out := &in.ConditionGroup, &out.ConditionGroup
		*out = new(ConditionGroup)
		(*in).DeepCopyInto(*out)
	}
	if in.CEL != nil {
