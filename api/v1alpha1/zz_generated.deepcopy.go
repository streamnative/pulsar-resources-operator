...
func (in *OffloadPolicies) DeepCopyInto(out *OffloadPolicies) {
	*out = *in
	if in.ManagedLedgerOffloadMaxThreads != nil {
		in, out := &in.ManagedLedgerOffloadMaxThreads, &out.ManagedLedgerOffloadMaxThreads
		*out = new(int)
		**out = **in
	}
	if in.ManagedLedgerOffloadReadThreads != nil {
		in, out := &in.ManagedLedgerOffloadReadThreads, &out.ManagedLedgerOffloadReadThreads
		*out = new(int)
		**out = **in
	}
	if in.ManagedLedgerOffloadPrefetchRounds != nil {
		in, out := &in.ManagedLedgerOffloadPrefetchRounds, &out.ManagedLedgerOffloadPrefetchRounds
		*out = new(int)
		**out = **in
	}
	if in.ManagedLedgerOffloadThresholdInSeconds != nil {
		in, out := &in.ManagedLedgerOffloadThresholdInSeconds, &out.ManagedLedgerOffloadThresholdInSeconds
		*out = new(int64)
		**out = **in
	}
	if in.ManagedLedgerOffloadThresholdInBytes != nil {
		in, out := &in.ManagedLedgerOffloadThresholdInBytes, &out.ManagedLedgerOffloadThresholdInBytes
		*out = new(int64)
		**out = **in
	}
	if in.ManagedLedgerOffloadDeletionLagInMillis != nil {
		in, out := &in.ManagedLedgerOffloadDeletionLagInMillis, &out.ManagedLedgerOffloadDeletionLagInMillis
		*out = new(int64)
		**out = **in
	}
	if in.ManagedLedgerExtraConfigurations != nil {
		in, out := &in.ManagedLedgerExtraConfigurations, &out.ManagedLedgerExtraConfigurations
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ManagedLedgerOffloadAutoTriggerSizeThresholdBytes != nil {
		in, out := &in.ManagedLedgerOffloadAutoTriggerSizeThresholdBytes, &out.ManagedLedgerOffloadAutoTriggerSizeThresholdBytes
		*out = new(int64)
		**out = **in
	}
	if in.S3ManagedLedgerOffloadMaxBlockSizeInBytes != nil {
		in, out := &in.S3ManagedLedgerOffloadMaxBlockSizeInBytes, &out.S3ManagedLedgerOffloadMaxBlockSizeInBytes
		*out = new(int)
		**out = **in
	}
	if in.S3ManagedLedgerOffloadReadBufferSizeInBytes != nil {
		in, out := &in.S3ManagedLedgerOffloadReadBufferSizeInBytes, &out.S3ManagedLedgerOffloadReadBufferSizeInBytes
		*out = new(int)
		**out = **in
	}
	if in.GCSManagedLedgerOffloadMaxBlockSizeInBytes != nil {
		in, out := &in.GCSManagedLedgerOffloadMaxBlockSizeInBytes, &out.GCSManagedLedgerOffloadMaxBlockSizeInBytes
		*out = new(int)
		**out = **in
	}
	if in.GCSManagedLedgerOffloadReadBufferSizeInBytes != nil {
		in, out := &in.GCSManagedLedgerOffloadReadBufferSizeInBytes, &out.GCSManagedLedgerOffloadReadBufferSizeInBytes
		*out = new(int)
		**out = **in
	}
	if in.ManagedLedgerOffloadMaxBlockSizeInBytes != nil {
		in, out := &in.ManagedLedgerOffloadMaxBlockSizeInBytes, &out.ManagedLedgerOffloadMaxBlockSizeInBytes
		*out = new(int)
		**out = **in
	}
	if in.ManagedLedgerOffloadReadBufferSizeInBytes != nil {
		in, out := &in.ManagedLedgerOffloadReadBufferSizeInBytes, &out.ManagedLedgerOffloadReadBufferSizeInBytes
		*out = new(int)
		**out = **in
	}
